        ...
        <div className="container mx-auto max-w-4xl py-12 px-4 md:px-6">
          <div className="prose prose-invert max-w-none">
            ...
            <p className="mt-4 text-lg">
              Welcome to ForgeFlow Pilot. These Terms of Service bind you, the user, and us, the company. By using our service, you agree to these terms, which outline your rights and obligations. Please read them carefully.
            </p>
            ...
            <h2 id="changes">3. Changes to the Terms</h2>
            ...
            <h2 id="accounts">4. Account Registration & Responsibilities</h2>
            ...
            <h2 id="acceptable-use">5. Acceptable Use / User Conduct</h2>
            ...
            <h2 id="scope">6. Service Description & Scope</h2>
            ...
            <h2 id="ip">7. Data, Content & Intellectual Property</h2>
            ...
            <h2 id="disclaimers">8. Model Outputs & AI Disclaimers</h2>
            ...
            <h2 id="termination">13. Term and Termination</h2>
            ...
            <h2 id="retention">14. Data Retention & Export</h2>
            ...
            <h2 id="third-party">15. Third-Party Services & Links</h2>
            ...
            <h2 id="contact">18. Contact & Reporting</h2>
