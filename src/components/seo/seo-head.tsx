...
export function SEOHead({
  ...
  const fullTitle = title || 'ForgeFlow - Advanced MLOps Platform | Mehtab Rosul | ECX | EncryptArx';
  const fullDescription = description || 'ForgeFlow by Mehtab Rosul - Premier MLOps platform for enterprise AI. Advanced machine learning operations, data science automation, model deployment, and AI infrastructure. Trusted by ECX, EncryptArx, and leading organizations worldwide.';
  ...
  return (
    <>
      ...
      <meta name="publisher" content="ForgeFlow" />
      ...
      <meta property="og:site_name" content="ForgeFlow - Advanced MLOps Platform" />
      ...
      <meta property="twitter:site" content="@forgeflow" />
